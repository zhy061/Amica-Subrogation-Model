...
CREATE TABLE dl_T034847.ProcessedClaims (
  CLAIM_ID varchar(72)
...
--Populate ProcessedClaims with data from tables in dl_vsuperus
INSERT INTO dl_T034847.ProcessedClaims
(
  CLAIM_ID
  --fields derived from CLAIM
...
--pull from 'COVERAGE' table
  ...
  ,/**COVERAGE_PERIL_1**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Collision' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_2**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Property Damage' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_3**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Glass' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_4**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Towing and Labor' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_5**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Rental Reimbursement' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_6**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Wind' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_7**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Other' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_8**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Water' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_9**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Bodily Injury' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_10**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Personal Injury Protection' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_11**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Hail' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_12**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Medical Payments' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_13**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Theft' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_14**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Freeze' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_15**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Uninsured Motorist Property Damage' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_16**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Malicious Mischief and Vandalism' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_17**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Bodily Injury Reimbursement' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_18**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Fire' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_19**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Underinsured Motorist Bodily Injury' THEN 1 ELSE 0 END
  ,/**COVERAGE_PERIL_20**/ CASE COVERAGE.COVERAGE_PERIL WHEN 'Uninsured Motorist Bodily Injury' THEN 1 ELSE 0 END
...
FROM COVERAGE
  ...
  --WHERE CLAIM.CLAIM_CATEGORY = 'Home' --'Auto' 
